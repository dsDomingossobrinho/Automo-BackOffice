...
const chartData = [
  ...
  { month: 'Fev', value: 3000, growth: -8, color: 'bg-red-500' },
  { month: 'Mar', value: 5000, growth: 25, color: 'bg-green-500' },
  { month: 'Abr', value: 4500, growth: 15, color: 'bg-yellow-500' },
  { month: 'Mai', value: 6000, growth: 33, color: 'bg-purple-500' },
    ...
    <div className="border-border bg-card/40 rounded-xl border p-6">
      ...
      <div className="border-border/50 grid grid-cols-3 gap-4 border-t pt-4">
        <div className="text-center">
          ...
          <div className="text-muted-foreground text-xs">Receita Total</div>
        </div>
        <div className="text-center">
          <div className="text-2xl font-bold text-blue-500">+18%</div>
          <div className="text-muted-foreground text-xs">Taxa de Crescimento</div>
        </div>
        <div className="text-center">
