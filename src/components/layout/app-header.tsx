          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent>
              ...
              <DropdownMenuItem asChild>
                <AlertDialog>
                  <AlertDialogTrigger className="w-full text-left gap-2 rounded-sm px-2 py-1.5 text-sm dark:hover:bg-red-400 dark:hover:text-white hover:bg-red-200 hover:text-red-700">
                    <span>Logout</span>
                  </AlertDialogTrigger>
                  <AlertDialogContent>
                    <AlertDialogHeader>
